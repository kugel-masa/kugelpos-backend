...
"""
Locust performance test for Cart Service (Multi-Terminal Mode)

This test simulates the following scenario:
1. Create a cart
2. Add 20 items (with 3 second intervals)
3. Cancel the cart
4. Wait 3 seconds before repeating
...
Requires: terminals_config.json (created by setup_test_data.py)
"""
