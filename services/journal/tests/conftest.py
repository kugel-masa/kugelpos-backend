...
def set_env_vars():
    ...
    if is_local:
        os.environ["BASE_URL_JOURNAL"] = "http://localhost:8005"
        ...
        os.environ["BASE_URL_JOURNAL"] = f"https://journal.{remote_server}"
    ...
    os.environ["DB_NAME_PREFIX"] = "db_journal"
    os.environ["STORE_CODE"] = "5678"
    os.environ["TERMINAL_NO"] = "9999"
...
async def http_client(set_env_vars):
    ...
    base_url = os.environ.get("BASE_URL_JOURNAL")
