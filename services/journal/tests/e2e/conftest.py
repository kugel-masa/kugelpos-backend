...
Provides db drop fixture, http_client pointed at BASE_URL_JOURNAL, and
auto-marks tests with `e2e`. test_setup_data runs first.
"""
import os
...
async def http_client(_setup_journal_db):
