...
class SalesReportReceiptData(AbstractReceiptData[SalesReportDocument]):
    ...
    def make_receipt_body(self, report: SalesReportDocument, page: Page):
        ...
        #  税名称      　      99,999,999円
        #  税名称      　      99,999,999円
        page.lines.append(self.line_left("税 額"))
        for tax in report.taxes:
            if "内" in tax.tax_name:
                self._make_line_with_parentheses(tax.tax_name, tax.tax_amount, page)
            else:
