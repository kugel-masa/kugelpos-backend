...
"""Test health check endpoint for report service."""
...
async def test_health_endpoint(http_client: AsyncClient):
    ...
    # Check service name
    assert data["service"] == "report"

    # Check version format
    assert data["version"] == "1.0.0"

    # Check checks structure - report service checks MongoDB, Dapr sidecar and state store
