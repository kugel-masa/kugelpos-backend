...
- [X] T029 [P] サイズ/レイテンシ計測（SC-005/SC-006）: `/perf-test` 標準手順で 40 商品カートの gzip 後レスポンスサイズと変更系 API の p95 増分を計測し、結果を issue #148 にコメントで記録（R-008 の判断基準と突き合わせ。gzip は #147 完了が前提）
